...
df_temp2 <-  df_temp %>%
 ...
 df_temp2$FodderBeet.AboveGround.Live.Wt <- df_temp2 %>% select(ends_with(".Live.Wt")) %>% rowSums()

 df_temp2$FodderBeet.Leaf.Live.N <- df_temp2$FodderBeet.Leaf.Live.Wt*df_temp$FodderBeet.Leaf.NConc
 df_temp2$FodderBeet.Petiole.Live.N <- df_temp2$FodderBeet.Petiole.Live.Wt*df_temp$FodderBeet.Petiole.NConc
 df_temp2$FodderBeet.StorageRoot.Live.N <- df_temp2$FodderBeet.StorageRoot.Live.Wt*df_temp$FodderBeet.StorageRoot.NConc

 
# dates
obsData <- df_temp2 %>% mutate(Clock.Today = ymd(Clock.Today)) 
