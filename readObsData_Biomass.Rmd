...
#  tidyr::spread(VarName,VarValue)
 ...
 df_temp1$FodderBeet.Leaf.NConc <- df_temp1$FodderBeet.Leaf.NConc/100
 df_temp1$FodderBeet.Petiole.NConc <-df_temp1$FodderBeet.Petiole.NConc/100
 df_temp1$FodderBeet.StorageRoot.NConc <- df_temp1$FodderBeet.StorageRoot.NConc/100
 df_temp1$FodderBeet.Senesced.NConc <- df_temp1$FodderBeet.Senesced.NConc/100
...
summary(df_temp1)
 ...
 df_temp1$FodderBeet.Leaf.Live.N <- df_temp1$FodderBeet.Leaf.Live.Wt*df_temp$FodderBeet.Leaf.NConc
 df_temp1$FodderBeet.Petiole.Live.N <- df_temp1$FodderBeet.Petiole.Live.Wt*df_temp$FodderBeet.Petiole.NConc
 df_temp1$FodderBeet.StorageRoot.Live.N <- df_temp1$FodderBeet.StorageRoot.Live.Wt*df_temp$FodderBeet.StorageRoot.NConc
