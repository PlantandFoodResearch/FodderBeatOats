...
```{r}
 ...
 obsData_APSIM$FodderBeet.Petiole.N <- df_temp1$FodderBeet.Petiole.Live.Wt*obsData_APSIM$FodderBeet.Petiole.NConc
 obsData_APSIM$FodderBeet.StorageRoot.N <- df_temp1$FodderBeet.StorageRoot.Live.Wt*obsData_APSIM$FodderBeet.StorageRoot.NConc
 
 # Total biomass FIXME: not nice to overwhite here ... find better way to do it
 # df_temp1$FodderBeet.AboveGround.Live.Wt <- df_temp1 %>% dplyr::select(ends_with(".Live.Wt")) %>% rowSums() # FIXME: Some bug here
