...
pathFolderWork <- "C:/GitHubRepos/2017_FodderBeetOats/FodderBeatOats/Observed"  

write.xlsx(df,paste0(pathFolderWork,"/ObservedDataWorked_APSIMX.xlsx"), sheetName="OBS2", row.names = FALSE) 
```
